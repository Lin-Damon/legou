...
function LeguTop(topid){
	this.id=topid;
	// console.log(this.id);
	this.style = LeguTopStyle(topid);
	this.user = this.checkUser();
	function LeguTopStyle(id){
		var ele = document.getElementById(id);
		console.log(id);
		ele.className="legutop_style";
		ele.innerHTML="<div class='top-left'><a href='###' ><img  src='../img/top1.png'/><span style='color:#333333;line-height: 30px;vertical-align:middle'>乐购首页</span></a></div><div class='top-right'><div class='nav1'><a href='./logIn.html'>登录</a>&nbsp;<a href='./logIn.html'>注册</a></div>|<div class='nav2'>☰&nbsp;我的订单</div>|<div class='nav3'><img src='../img/top2.png'/>&nbsp;购物车</div>|<div class='nav4'>客服服务<span style='font-size: 5px;'>ⅴ</span></div>|<div class='nav5'><img src='../img/top3.png'/>我的小店<span style='font-size: 5px;'>ⅴ</span></div></div>"
...
LeguTop.prototype.Login_logout = function(a,b,c,d){
	...
	Inout[0].style.fontWeight="700"
	Inout[0].href=this.b;
	console.log(Inout);
	Inout[1].innerText=this.c;
	Inout[1].onclick=function(){
		Inout[0].innerHTML="登录";
		Inout[0].href="../pages/logIn.html";
		Inout[1].innerHTML="注册";
		Inout[1].onclick=function(){
			Inout[1].href="../pages/logIn.html";
		}
	}
	Inout[1].href=this.d;
}
LeguTop.prototype.Lgougouwu = function(a,b,c,d,e,f,g){
	...
	var homesrc =top_left.getElementsByTagName("a")[0];
	homesrc.href=a;
}
LeguTop.prototype.checkUser = function (){
	LGB.init();
	var user = LGB.getCurrentUser();
	if (user) {
		console.log(user);
		document.getElementsByClassName("nav1")[0].innerHTML = "<a href='./userCenter.html' >您好:"+user.getUsername()+"</a>"
		document.getElementsByClassName("nav3")[0].addEventListener("click",function(){
