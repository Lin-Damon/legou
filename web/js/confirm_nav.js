...
function toPayBtn(){
	...
	var s = money.innerText;
	if(s <= 0){
		return;
	}
	for (var i = 0;i<orders.length;i++) {
		LGB.save("Order",orders[i],successFN,errorFN);
	}
...
//	console.log(index);
	...
	LGB.getUserShopCar(function(shopcar){
		var delGoods = shopcar;
		console.log(delGoods);
		delGoods.splice(index,1);
		LGB.updateShopCar({"shopcar":delGoods},function(obj){
