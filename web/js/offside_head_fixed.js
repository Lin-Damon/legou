function Offside(id1,herf1,herf2,herf3,herf4){
	...
	this.OffsideStyle=function(){
		...
		//0ffside2是一直显示的购物车
		offside2.innerHTML="<a  style='text-decoration:none;'><img style='margin:4px 0 2px 2px;' src='../img/rightgou1.png' width='70%'/><br /><span>购物车</span></a>";
		...
		console.log(user);
		if(user){
			var userFavicon=user.attributes.favaicon;
			offsidelis[0].innerHTML="<a href='./userCenter.html'><img src="+userFavicon+" /></a>"
			var OffsidePhoto=offsidelis[0].getElementsByTagName("img");
			OffsidePhoto[0].style.cssText="display: block;width:20px;height:20px;border-radius:50%;border:1px solid white;margin:50px 8px 5px 0px;"
		}

		//购物车
		offsidelis[1].innerHTML="<a href="+herf1+" style='text-decoration:none;'><img style='margin:6px 0 3px 0;' src='../img/rightgou1.png' width='60%'/><br /><span>购物车</span></a>";
		//优惠券
		...
		//判断有没有购物车
		LGB.init();
		LGB.getUserShopCar(successd,errord);
